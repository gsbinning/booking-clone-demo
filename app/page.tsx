  ...
  return (
    <main className="bg-[#013B94]">
     <section className='max-w-7xl mx-auto p-6'>
      ...
      <h3 className='text-white py-5 text-xl'>Search low prices on hotels, home and much more...</h3>
     </section>
     ...
     <section className='rounded-t-lg bg-white p-6 mt-10 mx-auto max-w-7xl'>
      <div className='pt-5'>
